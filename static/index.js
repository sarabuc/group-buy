...
$(document).ready(() => {
    ...
    $.when(
        $.ajax({
            url: "/static/components/main_content.js",
            dataType: "script",
            crossDomain: true
        }),
        $.ajax({
            url: "/static/components/group_details.js",
            dataType: "script",
            crossDomain: true
        }),
...
init_page = () => {
    ...
    user_img_path = "/static/assets/img/client-img4.png"
...
route_to_group_details = (group_id) => {
    ...
    path_imgs_arr = [
        "/static/assets/img/slick1.jpg", 
        "/static/assets/img/slick2.jpg", 
        "/static/assets/img/slick3.jpg", 
        "/static/assets/img/slick4.jpg", 
        "/static/assets/img/slick6.jpg", 
        "/static/assets/img/slick7.jpg"
    ]
    short_description_of_group = "yoyo stroller"
    brand_of_group_in_details = "yoyo"
    range_sum_for_group_product = "10.00$-50.00$"
    long_decription_of_group = "the best stroller for any child and baby in any age.... :)"
